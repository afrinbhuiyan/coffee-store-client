...
const Footer = () => {
    return (
        <div>
            <footer className=" bg-base-200 text-base-content p-10 flex flex-col lg:flex-row lg:px-80 mt-20">
                <div className="flex-1">
                    ...
                    <nav>
                        ...
                        <a className="flex items-center hover:underline text-[#361c0d] mb-2">
                            <FaPhone className="mr-4"></FaPhone> <span>+88 01345 999 33 1111</span></a>
                        <a className="flex items-center hover:underline text-[#361c0d] mb-2">
                            <MdEmail className="mr-4"></MdEmail> <span>Coffee.Store@email.com</span> </a>
                        <a className="flex items-center hover:underline text-[#361c0d]">
                            <IoLocationSharp className="mr-4"></IoLocationSharp>
                            <span>72 wall scool, King Road, Dhaka</span></a>
                    </nav>
                </div>
                <div className="hero flex-1">
                    <div className="w-full">
                        <form>
                            ...
                            <div className="form-control">
                                <label className="label">
                                    <span className="label-text">Messeage</span>
                                </label>
