        ...
        <div>
            ...
            <div className="bg-base-200 p-5 lg:p-10 rounded-md w-screen lg:w-2/3 mx-auto mt-10 my-auto">
                <div className="text-center">
                    <h1 className="text-4xl dancing-script">Update Coffee</h1>
                ...
                <form onSubmit={handleUpdateCoffee} className="card-body">
                    ...
                    <div className="lg:flex gap-5">
                        <div className="form-control flex-1">
                            ...
                            <input type="text" name="name" defaultValue={name} placeholder="Coffee Name" className="input" required />
                        </div>
                        <div className="form-control flex-1">
                            <label className="label">
                                <span className="label-text">Available Quantity</span>
                            </label>
                            <input type="text" name="quantity" defaultValue={quantity} placeholder="Available Quantity" className="input" required />
                        </div>
                    </div>
                    ...
                    <div className="lg:flex gap-5">
                        <div className="form-control flex-1">
                            ...
                            <input type="text" name="supplier" defaultValue={supplier} placeholder="Supplier Name" className="input" required />
                        </div>
                        <div className="form-control flex-1">
                            <label className="label">
                                <span className="label-text">Taste</span>
                            </label>
                            <input type="text" name="taste" defaultValue={taste} placeholder="Taste" className="input" required />
                        </div>
                    </div>
                    ...
                    <div className="lg:flex gap-5">
                        <div className="form-control flex-1">
                            ...
                            <input type="text" name="category" defaultValue={category} placeholder="Category" className="input" required />
                        </div>
                        <div className="form-control flex-1">
                            <label className="label">
                                <span className="label-text">Details</span>
                            </label>
                            <input type="text" name="details" defaultValue={details} placeholder="Details" className="input" required />
                        </div>
                    </div>
                    {/* from photo url row */}
                    <div className="form-control">
                        ...
                        <input type="text" name="photo" defaultValue={photo} placeholder="Photo URL" className="input" required />
                        <label className="label">
                            <a href="#" className="label-text-alt link link-hover">Forgot password?</a>
                        </label>
                    </div>
                    <div className="form-control mt-6">
                        <input type="submit" value="Update Coffee" className="btn dancing-script text-[20px] border-2 text-[#522d20] border-[#522d20] bg-[#ce943e6e] 
